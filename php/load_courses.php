...
echo "<script>setTimeout(updateDom,500,$grad_year);</script>";
// echo "<script>setTimeout(setRequirements,700,'2019');</script>";
// echo "<script>setTimeout(updateReqsList,900);</script>";
